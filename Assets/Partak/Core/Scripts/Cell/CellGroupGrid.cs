...
namespace GeoTetra.Partak
{
    public class CellGroupGrid
    {
        ...
        private CellGroup[] BuildCellGroupLayerFromParticleCellGrid(
        ...
        private void ConnectDiagonalNeighborCellGroup(CellGroup parentCellGroup, CellGroup baseCellGroup,
        ...
        private void ConnectChildCellGroups()
        {
        }
    }
}