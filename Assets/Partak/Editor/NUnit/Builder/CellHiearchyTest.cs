...
namespace Partak
{
	...
	public class CellHiearchyTest
	{
		...
		{
			ParticleCellGrid particleCellGrid = new ParticleCellGrid(192, 192);
			CellGroupGrid cellGroupGrid = new CellGroupGrid(particleCellGrid);
		...
		{
			ParticleCellGrid particleCellGrid = new ParticleCellGrid(192, 192);
			CellGroupGrid cellGroupGrid0 = new CellGroupGrid(particleCellGrid);
			CellGroupGrid cellGroupGrid1 = new CellGroupGrid(cellGroupGrid0);

			if (cellGroupGrid1.Grid.Length == 96 * 96)
			{
				DrawRayFromCellGroupCorner(cellGroupGrid1.Grid);
				Assert.Pass("Elements: " + ElementsInArray(cellGroupGrid1.Grid) + " Null Elements: " + NullElementsInArray(cellGroupGrid1.Grid));
			}
			else
			{
				Assert.Fail();
		...
		public void BuildParentCellGroupLayer1RightNullTest()
		{
			...
			if (cellGroup.DirectionalCellGroupArray[Direction12.NWW] == cellGroupGrid1.Grid[0] && 
				cellGroup.DirectionalCellGroupArray[Direction12.NWW].CellGroupGrid.ParentLevel == cellGroupGrid1.ParentLevel)
			{
				Assert.Pass();
			}
			else
		...
		public void BuildParentCellGroupLayer2SizeTest()
		{
			...
			CellGroupGrid cellGroupGrid0 = new CellGroupGrid(particleCellGrid);
			CellGroupGrid cellGroupGrid1 = new CellGroupGrid(cellGroupGrid0);
			CellGroupGrid cellGroupGrid2 = new CellGroupGrid(cellGroupGrid1);

			if (cellGroupGrid2.Grid.Length == 48 * 48)
			{
				DrawRayCellGroupArray(cellGroupGrid2.Grid);
				Assert.Pass("Elements: " + ElementsInArray(cellGroupGrid2.Grid) + " Null Elements: " + NullElementsInArray(cellGroupGrid2.Grid));
			}
			else
			{
				Assert.Fail("Elements: " + ElementsInArray(cellGroupGrid2.Grid) + " Null Elements: " + NullElementsInArray(cellGroupGrid2.Grid));
			}
		}
		...
		public void BuildParentCellGroupLayer3SizeTest()
		{
			...
			CellGroupGrid cellGroupGrid1 = new CellGroupGrid(cellGroupGrid0);
			CellGroupGrid cellGroupGrid2 = new CellGroupGrid(cellGroupGrid1);
			CellGroupGrid cellGroupGrid3 = new CellGroupGrid(cellGroupGrid2);

			if (cellGroupGrid3.Grid.Length == 24 * 24)
			{
				DrawRayCellGroupArray(cellGroupGrid3.Grid);
				Assert.Pass("Elements: " + ElementsInArray(cellGroupGrid3.Grid) + " Null Elements: " + NullElementsInArray(cellGroupGrid3.Grid));
			}
			else
			{
				Assert.Fail();
		...
		public void BuildParentCellGroupLayer4SizeTest()
		{
			...
			CellGroupGrid cellGroupGrid2 = new CellGroupGrid(cellGroupGrid1);
			CellGroupGrid cellGroupGrid3 = new CellGroupGrid(cellGroupGrid2);
			CellGroupGrid cellGroupGrid4 = new CellGroupGrid(cellGroupGrid3);

			if (cellGroupGrid4.Grid.Length == 12 * 12)
			{
				DrawRayFromCellGroupCorner(cellGroupGrid4.Grid);
				Assert.Pass("Elements: " + ElementsInArray(cellGroupGrid4.Grid) + " Null Elements: " + NullElementsInArray(cellGroupGrid4.Grid));
			}
			else
			{
				Assert.Fail();
		...
		private void DrawRayTraverseCellGroupArray(CellGroup[] cellGroupArray, int startIndex, int direction, Color color)
		{
			int runTimeout = 0;
		...
		private void DrawRayTraverseParticleCellArray(ParticleCell[] particleCellArray, int startIndex, int direction, Color color)
		{
			int runTimeout = 0;
