...
public class CellGroupGrid {
	...
	CellGroup[] BuildCellGroupLayerFromParticleCellGrid(ParticleCellGrid particleCellGrid, CellGroupGrid parentCellGroupGrid) {
	...
	CellGroup[] BuildParentCellGroupLayer(CellGroupGrid baseCellGroupGrid, CellGroupGrid parentCellGroupGrid) {
...
//						childCellGroupArray[i].InStepArray = 2;
	...
	void ConnectStraightNeighborCellGroup(
		...
		if (neighborCellGroup != null) {
			if (neighborCellGroup.CellGroupGrid.ParentLevel == parentCellGroup.CellGroupGrid.ParentLevel) {
				...
				neighborCellGroup.ChildCellGroupArray[oppositeChildCellGroupIndex].DirectionalCellGroupArray[oppositeDirectionA] = parentCellGroup;
				neighborCellGroup.ChildCellGroupArray[oppositeChildCellGroupIndex].DirectionalCellGroupArray[oppositeDirectionB] = parentCellGroup;
				neighborCellGroup.ChildCellGroupArray[oppositeChildCellGroupIndex].DirectionalCellGroupArray[diagonalDirection] = parentCellGroup;
	...
	void ConnectDiagonalNeighborCellGroup(CellGroup parentCellGroup, CellGroup baseCellGroup, int oppositeChildCellGroupIndex, int neighborDirection, int oppositeDirection) {
		CellGroup neighborCellGroup = baseCellGroup.DirectionalCellGroupArray[neighborDirection];				
		parentCellGroup.DirectionalCellGroupArray[neighborDirection] = neighborCellGroup;
		if (neighborCellGroup != null) {
			neighborCellGroup.DirectionalCellGroupArray[CellUtility.InvertDirection(neighborDirection)] = parentCellGroup;
			if (neighborCellGroup.CellGroupGrid.ParentLevel == parentCellGroup.CellGroupGrid.ParentLevel) {
				neighborCellGroup.ChildCellGroupArray[oppositeChildCellGroupIndex].DirectionalCellGroupArray[oppositeDirection] = parentCellGroup;
			}
		}
	}
