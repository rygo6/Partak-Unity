...
namespace Partak.UI
{
	public class LevelGallery : MonoBehaviour
	{
		...
		[SerializeField]
		public float _transitionSpeed = 4f;
		...
		{		
			...
			_material.SetTexture("_Texture1", (Texture)Resources.Load("LevelPreviews/" + _playerSettings.LevelIndex));	
		}
		...
		{			
			...
			_playerSettings.LevelIndex += direction;

			_material.SetTexture("_Texture2", (Texture)Resources.Load("LevelPreviews/" + _playerSettings.LevelIndex));	
